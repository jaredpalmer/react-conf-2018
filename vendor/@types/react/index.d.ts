...
declare namespace React {
    ...
    type ReactPlaceholder = {} | ReactNodeArray;
    type ReactNode = ReactPlaceholder | ReactChild | ReactFragment | ReactPortal | string | number | boolean | null | undefined;
    ...
    const Placeholder: ComponentType<{ delayMs?: number; fallback: React.ReactNode }> ;
    ...
    function useContext<C>(ctx: Context<C>): C; // there might be a better way to do this
    function useState<S>(initialState: S | (() => S)): [S, Updater<S>];
    function useEffect(cb:  void | (() => void), inputs?: any[]): void;
    function useMemo<V>(cb: (() => void), inputs?: any[]): V;
    function useCallback<V>(cb: (() => void), inputs?: any[]): V;
    function useReducer<S, A>(reducer: Reducer<S, A>, initialState: S, initialAction?: A): [S, Dispatcher<A>];
}
